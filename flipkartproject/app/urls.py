...
urlpatterns = [
    ...
    path('clothlist/',views.mobilelist,name="clothlist"),
    path('shoselist/',views.mobilelist,name="shoselist"),
    path('Electronicslist/',views.mobilelist,name="Electronicslist"),
    ...
    path("addadress_single/<productid>/",views.addadress_single,name="addadress_single"),
    path("addadress_all/",views.addadress_all,name="addadress_all"),
